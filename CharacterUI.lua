...
-- The same CharacterPreview module is shared by CharacterUI,
-- MainMenu character creation, and CharacterCard.
...
local viewport = CharacterPreview.Create(viewportContainer, {
AddCorner = addCorner,
})
...
local function renderCharacterViewport(viewportFrame, sourceCharacter)
    ...
    local rendered = CharacterPreview.Render(viewportFrame, sourceCharacter)
